...
export const HierarchyTree: React.FC<HierarchyTreeProps> = ({
  ...
  return (
    <div className={`ml-3 border-l ${isDark ? 'border-white/5' : 'border-slate-200'} pl-2`}>
      <div className="flex items-center gap-1 group" id={`sidebar-item-${node.id}`}>
        ...
        <button 
          ...
          className={`text-[10px] py-1 px-1.5 rounded flex-1 text-left transition-all flex items-center gap-0.5 ${
            isSelected 
