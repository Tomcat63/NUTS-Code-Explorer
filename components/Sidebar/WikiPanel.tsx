  ...
  return (
    <div className="flex flex-col animate-in slide-in-from-right duration-300">
      ...
      <div className="p-6">
        ...
        <a href={wikiData.url} target="_blank" rel="noreferrer" className="inline-block px-3.5 py-1.5 bg-blue-500 text-white text-[10px] font-bold rounded-lg hover:bg-blue-600 transition-colors">Wiki Artikel</a>
      </div>
    </div>
  );
};
